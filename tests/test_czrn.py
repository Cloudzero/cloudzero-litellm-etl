...
class TestCZRNGenerator:
    ...
    def test_create_from_components(self):
        ...
        expected = 'czrn:litellm:openai:cross-region:key-abc123def456:llm-usage:user|test_user|gpt-3.5-turbo'
    ...
    def test_create_from_litellm_data(self):
        ...
        # Should follow the pattern: czrn:litellm:openai:cross-region:test-user-123:llm-usage:gpt-3.5-turbo
        assert czrn == 'czrn:litellm:openai:cross-region:test-user-123:llm-usage:gpt-3.5-turbo'
    ...
    def test_component_extraction(self):
        ...
        czrn = 'czrn:litellm:openai:cross-region:key-abc123:llm-usage:user|test_user|gpt-3.5-turbo'
        
        components = generator.extract_components(czrn)
        expected = ('litellm', 'openai', 'cross-region', 'key-abc123', 'llm-usage', 'user|test_user|gpt-3.5-turbo')
    ...
    def test_team_entity_type(self):
        ...
        assert czrn.endswith(':gpt-4')
        assert czrn.startswith('czrn:litellm:openai:cross-region:')
    ...
    def test_unknown_provider_handling(self):
        ...
        assert czrn.startswith('czrn:litellm:unknown:cross-region:')
